...
- Public contract／Storefront Client／Testkit／immutable Artifact変更0。集計はAGENCY-003、Last Click／Attribution hookはAGENCY-004へDeferred。V1 Repository／DB／他Domain／他V1 service変更0、Production mutation／Migration apply／Activation 0。Rollbackは既存vhostとRuntime image復元、security history作成後の000074 schemaは保持しforward correctionとする。
