...
- Application Head `47f4e56fba8efbaf344027421072ab33b31895fe`からPreview APIを`sha256:1f906e80...`、Adminを`sha256:58a01cfd...`へ更新した。Migrationなし、固定IP／Network／Environment Key集合は維持した。
