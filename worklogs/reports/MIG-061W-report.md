...
- PR Policy GateはGovernance必須見出し、Task metadata、Changed files／Allowed pathsのexact list不足を検出した。PR本文をCanonical Schemaへ補正し、再Policy GateはPASSした。Gate条件とApplication差分は変更していない。
