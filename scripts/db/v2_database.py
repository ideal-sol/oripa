...
EXPECTED_V2_SCHEMA_INVENTORY = [
    ...
    "public.catalog_gacha_rank_video_revisions",
    "public.catalog_gacha_ranks",
    ...
    "public.catalog_rank_effect_materials",
    "public.catalog_rank_master_revisions",
    "public.catalog_rank_masters",
    ...
    "public.draw_results",
    "public.export_jobs",
    "public.external_identity_account_histories",
    "public.external_identity_accounts",
    "public.external_identity_transactions",
    ...
    "public.user_advertising_attributions",
...
def task_marker(task_id: str) -> str:
    ...
    if not re.fullmatch(r"(?:mig[0-9]{3}[a-z]?|agency00[123]|agency004a)", marker):
