...
class AdminGachaRankResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'rank_image_asset_ids' => $this->whenLoaded('rankImageAssets', fn () => $this->rankImageAssets->pluck('id')->values()),
            'rank_image_assets' => RankAssetResource::collection($this->whenLoaded('rankImageAssets')),
            ...
            'draw_video_asset_ids' => $this->whenLoaded('drawVideoAssets', fn () => $this->drawVideoAssets->pluck('id')->values()),
            'draw_video_assets' => RankAssetResource::collection($this->whenLoaded('drawVideoAssets')),
