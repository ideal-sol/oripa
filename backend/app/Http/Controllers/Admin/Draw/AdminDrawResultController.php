...
class AdminDrawResultController extends Controller
{
    public function index(Request $request): AnonymousResourceCollection
    {
        $query = DrawResult::query()
            ->with(['user', 'gacha', 'rank.rankImageAsset', 'rank.rankImageAssets', 'rank.drawVideoAsset', 'rank.drawVideoAssets', 'prize', 'userPrize', 'probabilityVersion', 'probabilityVersionStage'])
            ->orderByDesc('id');
    ...
    public function show(DrawResult $drawResult): AdminDrawResultResource
    {
        return new AdminDrawResultResource($drawResult->load([
            ...
            'gacha',
            'rank.rankImageAsset',
            'rank.rankImageAssets',
            'rank.drawVideoAsset',
            'rank.drawVideoAssets',
            'prize',
            'userPrize',
            'probabilityVersion',
