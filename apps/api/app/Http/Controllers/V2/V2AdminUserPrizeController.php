...
final class V2AdminUserPrizeController
{
    public function __construct(
        private readonly V2AdminUserPrizeReadService $service,
    ...
    public function index(Request $request): JsonResponse
    {
        return $this->handle($request, fn (V2AdminAuthorizationContext $context): array =>
            $this->service->listing($context, $request->query()));
    }

    public function show(Request $request, string $userPrizeId): JsonResponse
    {
        return $this->handle($request, fn (V2AdminAuthorizationContext $context): array =>
            $this->service->detail($context, $userPrizeId));
    }
