...
class UpdateGachaRankRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'rank_image_asset_ids' => ['sometimes', 'nullable', 'array'],
            'rank_image_asset_ids.*' => ['integer', 'distinct', Rule::exists('rank_assets', 'id')->where('asset_type', 'image')],
            ...
            'draw_video_asset_ids' => ['sometimes', 'nullable', 'array'],
            'draw_video_asset_ids.*' => ['integer', 'distinct', Rule::exists('rank_assets', 'id')->where('asset_type', 'video')],
