...
final class V2PersistentSecurityEventSink implements V2SecurityEventSink
{
    private const ACTIONS = [
        ...
        'email_change_failed' => 'identity.email_change.failed',
        'email_change_rate_limited' => 'identity.email_change.rate_limited',
        'email_change_requested' => 'identity.email_change.requested',
        'email_change_succeeded' => 'identity.email_change.succeeded',
        'password_change_failed' => 'identity.password_change.failed',
        'password_change_rate_limited' => 'identity.password_change.rate_limited',
        'password_change_succeeded' => 'identity.password_change.succeeded',
