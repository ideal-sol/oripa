...
Package Versionは`2.0.0-alpha.26`。参照するStorefront Clientは`2.0.0-alpha.26`、
Site Schemaは`2.0.0-alpha.23`、Public OpenAPI Contractは`2.0.0-alpha.25`。トップ表示対象／対象外Banner、Footer表示対象／対象外Static Page、Point商品一覧／
