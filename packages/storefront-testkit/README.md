...
Versionは`2.0.0-alpha.16`。トップ表示対象／対象外Banner、Footer表示対象／対象外Static Page、Gacha Catalogの販売状態／
Eligibility／表示制御、User Prize Presentation、型付きDraw／Fulfillment Problem Contract、
